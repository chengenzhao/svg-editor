...
import com.whitewoodcity.svgeditor.top.BlendModeChoice;
import com.whitewoodcity.svgeditor.top.EffectParameters;
import com.whitewoodcity.svgeditor.top.OpacityParameter;
...
//  public FillParameters fillParameters = new FillParameters();
  ...
  public TopBox() {
    this.getChildren().addAll(new HBox(pathElements),new HBox( effectParameters,blendModeChoice,opacityParameter));
